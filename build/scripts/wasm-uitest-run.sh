...
export UNO_UITEST_PROJECT=$BUILD_SOURCESDIRECTORY/src/Chefs.UITests/Chefs.UITests.csproj
export UNO_UITEST_BINARY=$BUILD_SOURCESDIRECTORY/src/Chefs.UITests/bin/Release/net48/Chefs.UITests.dll
export UNO_UITEST_LOGFILE=$BUILD_ARTIFACTSTAGINGDIRECTORY/screenshots/wasm/nunit-log.txt
export UNO_UITEST_WASM_PROJECT=$BUILD_SOURCESDIRECTORY/src/Chefs.Wasm/Chefs.Wasm.csproj
export UNO_UITEST_WASM_OUTPUT_PATH=$BUILD_SOURCESDIRECTORY/src/Chefs.Wasm/bin/Release/net8.0/dist/
...
dotnet build /p:Configuration=Release $UNO_UITEST_WASM_PROJECT /p:IsUiAutomationMappingEnabled=True /p:OverrideTargetFramework=net8.0
