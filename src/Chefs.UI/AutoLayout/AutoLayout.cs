...
namespace Chefs.UI
{
    ...
    public partial class AutoLayout : Control
    {
        ...
        public AutoLayout()
        {
            ...
            RegisterDisposablePropertyChangedCallback(this, HorizontalAlignmentProperty, (snd, e) => UpdateAlignments());
            RegisterDisposablePropertyChangedCallback(this, VerticalAlignmentProperty, (snd, e) => UpdateAlignments());
            RegisterDisposablePropertyChangedCallback(this, PaddingProperty, (snd, e) => UpdateAlignments());
        }

        internal IDisposable RegisterDisposablePropertyChangedCallback(DependencyObject? instance, DependencyProperty property, DependencyPropertyChangedCallback callback)
        {
            if (instance == null)
            {
