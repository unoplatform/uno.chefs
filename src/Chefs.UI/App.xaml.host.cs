                ...
                new RouteMap("", View: views.FindByViewModel<ShellModel>(),
                        Nested: new RouteMap[]
                        {
                            ...
                            new RouteMap("Main", View: views.FindByViewModel<MainModel>(), Nested: new RouteMap[]
                            {
                                ...
                                new RouteMap("Ingredients", View: views.FindByViewModel<IngredientsModel>(), DependsOn: "HomeRecipeDetails"),
                                new RouteMap("LiveCooking", View: views.FindByViewModel<LiveCookingModel>(), DependsOn: "HomeRecipeDetails"),
                                new RouteMap("Reviews", View: views.FindByViewModel<ReviewsModel>(), DependsOn: "HomeRecipeDetails"),
