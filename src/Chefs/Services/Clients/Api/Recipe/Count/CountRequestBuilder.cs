...
namespace Chefs.Services.Clients.Api.Recipe.Count
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Chefs.Services.Clients.Api.Recipe.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Chefs.Services.Clients.Api.Recipe.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Chefs.Services.Clients.Api.Recipe.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Chefs.Services.Clients.Api.Recipe.Count.CountRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Chefs.Services.Clients.Api.Recipe.Count.CountRequestBuilder WithUrl(string rawUrl)
        {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.16.0")]
        public partial class CountRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Chefs.Services.Clients.Api.Recipe.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>
        {
        }
    }
}
