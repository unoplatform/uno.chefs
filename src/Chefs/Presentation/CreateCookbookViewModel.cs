...
public partial class CreateCookbookViewModel // DR_REV: Use Model suffix instead of ViewModel
{
    ...
    public async ValueTask Done(string cookbookName, IImmutableList<Recipe> recipes, CancellationToken ct)
    {
