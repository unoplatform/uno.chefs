...
namespace Chefs.Services.Clients.Api.Recipe.Review.Like
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Chefs.Services.Clients.Api.Recipe.Review.Like.LikeRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Chefs.Services.Clients.Models.ReviewData body, Action<RequestConfiguration<global::Chefs.Services.Clients.Api.Recipe.Review.Like.LikeRequestBuilder.LikeRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Chefs.Services.Clients.Models.ReviewData body, Action<RequestConfiguration<global::Chefs.Services.Clients.Api.Recipe.Review.Like.LikeRequestBuilder.LikeRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Chefs.Services.Clients.Api.Recipe.Review.Like.LikeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Chefs.Services.Clients.Api.Recipe.Review.Like.LikeRequestBuilder WithUrl(string rawUrl)
        {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.16.0")]
        public partial class LikeRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Chefs.Services.Clients.Api.Recipe.Review.Like.LikeRequestBuilder.LikeRequestBuilderPostQueryParameters>
        {
        }
    }
}
