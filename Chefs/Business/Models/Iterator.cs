...
// WORKAROUND This is a workaround until the following issue is resolved:
// https://github.com/unoplatform/uno.extensions/issues/2383 Once the issue is resolved, we should
// be able to use a single Iterator<T> class for both Step and int types.
